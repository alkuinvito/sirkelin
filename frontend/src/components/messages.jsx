...
function Loading() {
  return (
    <div className="text-center">
      <div role="status">
        <svg aria-hidden="true" className="inline w-8 h-8 mr-2 text-gray-900 animate-spin dark:text-gray-600 fill-purple-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const fetchRooms = async () => {
  const {data} = await Axios.get('https://sirkelin.cloud/api/private/')
