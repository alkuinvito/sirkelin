      ...
      <div className='w-96 px-4' style={montserrat.style}>
        <div className=''>
          <section className='flex gap-3'>
            ...
            <button className='w-12 p-2 rounded-full text-indigo-700 border border-indigo-700 hover:bg-indigo-700 hover:text-gray-200' onClick={() => setGetUsers(true)}><FontAwesomeIcon className='' icon={faPen}></FontAwesomeIcon></button>
          </section>
